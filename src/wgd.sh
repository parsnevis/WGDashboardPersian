...
# wgd.sh - Copyright(C) 2022 Mostafa Shoa [https://github.com/parsnevis]
...
help() {
  ...
  display_logo2
  printf "${YELLOW}=================================================================================\n"
  printf "${YELLOW}+     ${BLUE}<Wireguard Panel> by Mostafa Shoa ${BLUE}https://github.com/parsnevis        ${YELLOW}+\n"
  printf "${YELLOW}=================================================================================${NC}\n"
